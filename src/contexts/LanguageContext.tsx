...
const translations = {
  en: {
    ...
    seo: {
      ...
      'contact.description': 'Get in touch with Taamul Credit Review Services in Dubai. Call +971 4 452 1111, visit our TECOM office, or submit an inquiry for business financing support.',
