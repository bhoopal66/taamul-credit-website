...
const whyChooseUs = [
  {
    ...
    description: "Commercial and residential property accepted as collateral",
  },
  {
    icon: Key,
    title: "Asset Unlocking",
    description: "Release equity from existing assets for business growth",
  },
  {
    icon: TrendingDown,
    title: "Best Rates",
    description: "Lowest interest rates due to reduced lender risk",
  },
  {
    icon: BadgeCheck,
    title: "Approved Valuers",
    description: "Network of certified valuers for quick property assessment",
  },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-white/80">
              Unlock maximum value from your assets with our secured financing solutions.
            </p>
          </div>
